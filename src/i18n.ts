...
export const en_US = {
    ...
    texts: __declareEnglishTextsLocale({
        ...
        opt_multiple: d => 'multiple',
    }),
    issues: {
        InvalidOptionError: (e, d) => `option <${d.invalidValue(e.optionName)}> is invalid`,
        EmptyRequiredOptionError: (e, d) => `it's required`,
        InvalidInputError: (e, d) => `provided arguments were not correct`,
        SomeInvalidOptionsError: (e, d) => `some of the options are invalid`,
        ...
        InvalidSomeArgumentsError: (e, d) => `some of the arguments are invalid`,
        InvalidArgumentError: (e, d) => `provided argument value <${d.invalidValue(e.value)}> is not valid`,
